<div class="header">
	<ul class="header-options">
		...
		<li id="right" class="align-right"><a href="connectedview.php">CONNECTED VIEW</a></h3>
		<li class="align-right"><a href="about.php">ABOUT</a></h3>
	</ul>

	<h1 class="header-title">Canadian Law</h1> <!--Potentialy add scale symbol(s) next to Canadian Law-->
</div>
